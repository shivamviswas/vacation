...
<html>
<head>
    <title>Mountain Vacations || Explore your Vacations</title>
    <!-- meta tag start-->
    <meta http-equiv="Content-Type" content="text" charset="UTF-8">
    <meta name="viewport"
          content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <meta name="keywords" content="Mountain, mountain,
    vacations,Vacations, Mountain Vacations, mountain vacations,
    explore, vacations, Kullu, manali, Shimla, travel, agent,
    tour trip,trip, tour, travel agency">
...
window.onscroll = function() {scrollFunction()};
    ...
    function scrollFunction() {
        if (document.body.scrollTop > 60 || document.documentElement.scrollTop > 60) {
            ...
            $("#nav2").css({"width":"80%","top":"2%","background-color":"rgba(0,0,1,0.3)","left":"10%"})

        } else {

            if (window.matchMedia('(max-width: 800px)').matches|| window.matchMedia('(max-width: 420px)').matches || window.matchMedia('(max-width: 320px)').matches ) {
                $("#nav2").css({"width":"90%","top":"16%","background-color":"rgba(0,0,0,0)","left":"7%"})

            } else {

                $("#nav2").css({"width":"90%","top":"9%","background-color":"rgba(0,0,0,0)","left":"7%"})
            }
...
<!-- //blast color scheme -->
<!-- top header -->
<div class="header-top bg-theme" id="nav1" data-blast="bgColor">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <ul class="d-flex header-w3_pvt">
                    <li>
                        ...
                        <a href="mailto:yogi.thkr@gmail.com" class="text-white">yogi.thkr@gmail.com</a>
                    </li>
                    <li>
                        <span class="fa fa-phone"></span>
                        <a href="tel:9911905113" class="text-white">+91-9911905113</a>


                    </li>
                </ul>
            </div>
            <div class="col-sm-6 hearder-right-w3_pvt">
...
<div id="home">
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="nav2" >
            ...
            <button class="navbar-toggler ml-md-auto" data-blast="bgColor" type="button" data-toggle="collapse" data-target="#navbarSupportedContent"
                    ...
                    <li class="nav-item dropdown mr-lg-3 mt-lg-0 mt-3">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item scroll"  data-toggle="modal" aria-pressed="false"
                               data-target="#exampleModal">Sign in</a>
                        </div>
                    </li>
    ...
    <!-- //header -->
    <div class="callbacks_container carousel slide" id="silder_container" >
        <ul class="rslides" id="slider3">
            <li class="banner banner1">
                <div class="container">
                    <div class="banner-text" style="margin-top: 50px">
                        <div class="slider-info">
                            <span class="line">collect moments..</span>
                            <h3> The beautiful scenery of <span data-blast="bgColor">nature</span> Shimla!</h3>
                            <p class="text-white">Explore your vacations </p>
                    ...
                    <div class="banner-text">
                        <div class="container">
                            <div class="banner-text">
                                <div class="slider-info">
                                    <span class="line">collect moments..</span>
                                    <h3>The <span data-blast="bgColor">delightful</span> Kullu Manali!</h3>
                                    <p class="text-white">Explore your vacations </p>
                                                                <a class="btn bg-theme mt-4 w3_pvt-link-bnr scroll text-white" data-blast="bgColor"
                                                                   href="#about" role="button">View
                                                                    More</a>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-7 about-left-wthree bg-theme" data-blast="bgColor">
                ...
                <p class="my-3 text-right text-white child_second">We specialize in tours to <b>Himachal Pradesh</b> but are always expanding and enhancing our wide range of offers,
                    as well as adding new and exciting tours of <b>Shimala</b> and <b>Kullu Manali</b> in exciting prices .</p>
        ...
        <div class="row">
            <div class="col-lg-6 service-sub-grids">
                <div class="d-flex services-box">
                        <span class="icon">
                            <i class="fa fa-map-marker" data-blast="color"></i>
                        </span>
                ...
                <div class="d-flex services-box">
                        <span class="icon">
                            <i class="fa fa-globe" data-blast="color"></i>
                        </span>
                    <div class="service-content">
                        <span>All India</span>
                        <h4>We connecting more...</h4>
                    </div>
                </div>
            ...
            <div class="col-lg-6">
                ...
                <div class="my-auto service-top-img">
                    <img src="images/Shimla.jpg" alt="" class="img-fluid rounded" />
                </div>
            </div>
        </div>
    </div>
...
<section class="team-wthree py-3  position-relative bg-theme" data-blast="bgColor" id="team">
    <div class="container py-lg-5">
        <div class="title-desc text-left pb-3">
            <h3 class="main-title-w3pvt  text-capitalize text-white">Hotels</h3>
            <p class=" text-white"> We have wide range hotels in affordable price </p>
            <a href="#plans" class="text-capitalize text-dark w3_pvt-link-bnr btn bg-light scroll mt-sm-4">view more</a>
        </div>
        <div class="row">
            <div class="col-lg-8">
                                ...
                                <div class="col-md-6">
                                    <div class="box5">
                                        ...
                                        <div class="box-content">
                                            <h3 class="title">Yogender Thakur</h3>
                                            <span class="post">Partner</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="box5">
                                        ...
                                        <div class="box-content">
                                            <h3 class="title">Kamini Thakur</h3>
                                            <span class="post">Partner</span>
                                        </div>
                                    </div>
                                </div>
...
<section class="py-lg-5 py-4" id="plans">
    <div class="container py-md-5">
        <div class="title-desc text-right pb-sm-3">
            <h3 class="main-title-w3pvt  text-capitalize">our packages</h3>
...
<section class="wthree-row w3-gallery cliptop-portfolio-wthree pt-lg-5" id="portfolio">
    <div class="container-fluid">
        ...
        <ul class="demo row py-lg-5 py-sm-4 pb-4">
            ...
            <li class="col-lg-3 col-sm-6">
                <div class="gallery-grid1">
                    <img src="images/p5.jpg" alt=" " class="img-fluid img-thumbnail" />
                </div>
            </li>
            <li class="col-lg-3 col-sm-6">
                <div class="gallery-grid1">
...
<section class="blog_w3ls py-lg-5" id="posts">
    <div class="container py-sm-5 py-4">
        <div class="title-desc text-right pb-sm-3">
            <h3 class="main-title-w3pvt  text-capitalize">Offers</h3>
            <p>10% off in this month</p>
        </div>
            ...
            <div class="col-lg-12">
                <div class="w3_pvt-contact-top">
                    ...
                    <ul class="d-flex header-wthreelayouts pt-0 flex-column">
                        ...
                        <li class="my-3">
                            ...
                            <a href="mailto:yogi.thkr@gmail.com" class="text-secondary">yogi.thkr@gmail.com</a>
                        </li>
                        <li>
                            <span class="fa fa-phone"></span>
                            <a href="tel:9911905113" class="text-secondary">+91-9911905113</a>
                        </li>
                    </ul>
                </div>
                <hr>
                <div class="col-lg-12 mt-4">
                    ...
                    <div class="register-top1">
                        <form class="register-wthree" method="post" action="index.php" id="myform">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-3 pl-lg-0">
                                        ...
                                        <input class="form-control" type="text" placeholder="Jayash" id="contactName" name="name"
                                    ...
                                    <div class="col-lg-3 my-lg-0 my-4">
                                        ...
                                        <input class="form-control" id="contactEmail" type="email" placeholder="example@email.com"
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <input class="form-control" type="number" placeholder="9876543210" name="mobile"
                                               id="contactMobile"   required="" data-blast="borderColor">
                                    </div>
                                    <div class="col-lg-3 d-flex align-items-end pr-lg-0 mt-lg-0 mt-4">
                                        <button type="submit"  data-blast="bgColor" name="submit" class="btn btn-w3_pvt btn-block w-100 text-white font-weight-bold text-uppercase checkData bg-theme"> Send   </button>                                </div>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 text-lg-right mt-lg-4 mt-4">
                <p>© 2018 Trips. All rights reserved | Design by
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h5 class="modal-title text-success" id="exampleModalLabel"> <i class="fa fa-check"></i> Successfully Sent</h5>
            </div>
        </div>
    </div>
</div>
