...
<html>
<head>
    <title>Mountain Vacations || Explore your Vacations- Service</title>
    <!-- meta tag start-->
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="nav2" >
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent" >
                <ul class="navbar-nav ml-lg-auto text-center "  >
                    <li class="nav-item   mr-lg-3 mt-lg-0 mt-sm-3">
                    ...
                    <li class="nav-item dropdown mr-lg-3 mt-lg-0 mt-3">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item  " href="package.php">pricing</a>
    ...
    <div class="banner-text">
                        <div class="container">
                                ...
                                <div class="slider-info">
                                    ...
                                    <h3><span data-blast="bgColor">Service</span></h3>
